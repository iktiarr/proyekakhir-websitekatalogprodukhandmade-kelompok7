<section id="pricing" class="py-16 bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="text-center mb-12">
      <h2 class="text-3xl font-bold text-slate-800 dark:text-slate-100 tracking-tight">
        Layanan Custom <span class="text-lime-600">Kerajinan Tangan</span>
      </h2>
      <p class="text-slate-500 dark:text-slate-400 mt-2 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
        Pesan pembuatan kerajinan kustom khas Madura yang disesuaikan khusus dengan keinginan, warna, ukuran, atau motif pilihan Anda.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto items-stretch">
      ...
      <div class="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 flex flex-col justify-between">
        <div>
          ...
          <p class="text-slate-500 dark:text-slate-400 text-xs leading-relaxed mb-6">
            Layanan kustomisasi untuk aksesoris etnik berukuran kecil dan cinderamata sederhana khas Madura.
          </p>
          
          <div class="mb-6">
            <p class="text-[10px] uppercase font-extrabold text-slate-400 tracking-widest">Mulai Dari</p>
            <p class="text-3xl font-extrabold text-slate-800 dark:text-slate-100 mt-1">
              Rp 50.000 <span class="text-xs font-normal text-slate-400 dark:text-slate-500">/ jasa</span>
            </p>
          </div>
          ...
          <ul class="space-y-3.5 text-xs sm:text-sm text-slate-600 dark:text-slate-400">
            <li class="flex items-center gap-2.5">
              ...
              <span>Kustom aksesoris kecil (gelang, gantungan kunci, dll.)</span>
            </li>
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Pilihan kombinasi warna dasar benang / manik</span>
            </li>
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Estimasi pengerjaan cepat 1-3 hari</span>
            </li>
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Kemasan kantong kertas daur ulang</span>
            </li>
          </ul>
        </div>
      ...
      <div class="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 flex flex-col justify-between relative">
        ...
        <div>
          ...
          <p class="text-slate-500 dark:text-slate-400 text-xs leading-relaxed mb-6">
            Kustomisasi anyaman lontar/bambu ukuran sedang, kipas hias, atau tas kecil bermotif khusus.
          </p>
          
          <div class="mb-6">
            <p class="text-[10px] uppercase font-extrabold text-slate-400 tracking-widest">Mulai Dari</p>
            <p class="text-3xl font-extrabold text-slate-800 dark:text-slate-100 mt-1">
              Rp 100.000 <span class="text-xs font-normal text-slate-400 dark:text-slate-500">/ jasa</span>
            </p>
          </div>
          ...
          <ul class="space-y-3.5 text-xs sm:text-sm text-slate-600 dark:text-slate-400">
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Kustom anyaman lontar/bambu ukuran sedang (kipas, tas, dll.)</span>
            </li>
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Bebas pilih variasi motif khas & perpaduan warna</span>
            </li>
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Konsultasi detail pesanan via WhatsApp</span>
            </li>
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Kemasan kardus cokelat minimalis & rapi</span>
            </li>
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Laporan foto progres pengerjaan kerajinan</span>
            </li>
          </ul>
        </div>
      ...
      <div class="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl border border-slate-200 dark:border-slate-800 flex flex-col justify-between">
        <div>
          ...
          <p class="text-slate-500 dark:text-slate-400 text-xs leading-relaxed mb-6">
            Layanan kustomisasi eksklusif untuk seni relief kayu jati mini, motif batik tulis khusus, atau wadah tenun sutra.
          </p>
          
          <div class="mb-6">
            <p class="text-[10px] uppercase font-extrabold text-slate-400 tracking-widest">Mulai Dari</p>
            <p class="text-3xl font-extrabold text-slate-800 dark:text-slate-100 mt-1">
              Rp 200.000 <span class="text-xs font-normal text-slate-400 dark:text-slate-500">/ jasa</span>
            </p>
          </div>
          ...
          <ul class="space-y-3.5 text-xs sm:text-sm text-slate-600 dark:text-slate-400">
            ...
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Bahan serat premium & kayu jati Madura pilihan berkualitas</span>
            </li>
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Konsultasi desain langsung dengan pengrajin seni</span>
            </li>
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Gratis kartu ucapan kayu grafir nama kustom</span>
            </li>
            <li class="flex items-center gap-2.5">
              <i class="fa-solid fa-circle-check text-lime-600 text-sm"></i>
              <span>Kotak hampers premium eksklusif berhias pita tali rami</span>
            </li>
          </ul>
        </div>
