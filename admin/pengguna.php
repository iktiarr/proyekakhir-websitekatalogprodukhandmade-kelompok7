...
<body class="bg-slate-50 flex text-slate-800 selection:bg-lime-200 selection:text-lime-900">
    ...
    <aside class="w-56 bg-white min-h-screen border-r border-slate-200 flex flex-col sticky top-0 shadow-sm z-10">
        ...
        <nav class="flex-1 px-3 space-y-1">
            ...
            <a href="pengguna.php" class="flex items-center px-3.5 py-2.5 bg-lime-50 text-lime-700 rounded-lg font-bold text-sm transition-colors">
            ...
            <table class="w-full text-left">
                <thead class="bg-slate-50 text-slate-400 text-[10px] uppercase tracking-wider font-bold border-b border-slate-100">
                    <tr>
                        ...
                        <th class="px-4 py-3.5 pr-6">Bergabung Pada</th>
                    </tr>
                </thead>
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors duration-200 text-xs sm:text-sm">
                        <td class="px-4 py-3 pl-6">
                            <div class="flex items-center space-x-3">
                                <div class="w-8 h-8 <?= $row['role'] === 'admin' ? 'bg-lime-100 text-lime-700' : 'bg-slate-100 text-slate-500'; ?> rounded-full flex items-center justify-center font-bold text-xs shadow-sm flex-shrink-0">
                        ...
                        <td class="px-4 py-3 pr-6 text-xs font-medium text-slate-400 whitespace-nowrap">
