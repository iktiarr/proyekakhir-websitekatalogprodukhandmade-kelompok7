                ...
                <div class="relative rounded-xl overflow-hidden shadow-sm border border-slate-200/60 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 aspect-square group">
                    ...
                    <div class="absolute top-4 left-4 flex gap-2">
                        ...
                        <?php if(!empty($data_produk['nama_daerah'])): ?>
                            <span class="bg-lime-600/95 backdrop-blur-sm px-3 py-1.5 rounded-xl text-[10px] font-bold text-white shadow-sm border border-lime-600 uppercase tracking-widest flex items-center gap-1">
